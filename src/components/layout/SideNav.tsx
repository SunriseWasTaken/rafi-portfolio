...
export function SideNav() {
  ...
  return (
    <>
      ...
      <div
        className="pointer-events-none fixed inset-y-0 left-44 z-40 hidden w-7 border-r border-border-subtle bg-background/40 lg:block"
        aria-hidden="true"
      >
        <div className="flex flex-col items-end px-1.5 py-8 font-mono text-[9px] leading-[1.35rem] text-muted-light/35">
